<%@ page language="java" import="com.foodmon.model.User" import="com.foodmon.model.Cart" import="java.util.*"
...
<body>
	...
	<div
		...
		<div
			...
			<main class="form-signin p-4 ">
				...
				<form action="userlogin" method="post">
					<div class="d-flex justify-center item-center mx-4">
						<h2>foodm</h2>
						<img alt="foodlogo" src="./assets/foodLogo.png" class=""
							style="height: 30px;">
						<h2 class=" " href="#">n</h2>
					</div>
			...
			<div>
				<img alt="foodlogo" src="./assets/background.jpg" class=""
					style="height: 500px;">
